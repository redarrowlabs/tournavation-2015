...
Feature requests are welcome, but take a moment to find out whether your idea fits with the scope and aims of the project. Project features should be validated against the project research and problem statement. It's up to *you* to make a strong case to convince the merits of the feature. Please provide as much detail and context as possible.  

It is recommended that features be added as User Stories, following the BDD approach where applicable.  A strong story narrative and detailed scenarios can help identify the user needs and test cases.  Be sure to apply the correct labels and milestone to features.
